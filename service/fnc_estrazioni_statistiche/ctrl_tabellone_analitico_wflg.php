...
$today = date ( "Y-m-d" );
$tabella = "tabelloneanalitico_wflg_" . lastdate10el5($today). $today;
...
$html = aggiungi_titolo('Tabellone analitico Win For Life Grattacielo <br /> '. data_estesa($today) .' ore '. $r_estrazioni[0]->ora .' numero ' . $ne);
