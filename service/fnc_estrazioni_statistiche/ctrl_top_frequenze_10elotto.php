...
$tabella = "lotto_maxritardiattuali_10elotto" . lastdate ();
...
echo '<h2 class="titolo row">I numeri piu\' frequenti<br /> 10 e lotto serale</h2>';
echo '</div>';
...
foreach ( $listAll as $key1 ) {
	...
	//print_r (array_sort ( $key1, 'fre', SORT_ASC));
	echo '<tr>';
