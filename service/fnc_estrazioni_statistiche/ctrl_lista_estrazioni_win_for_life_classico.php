...
$r_estrazioni = Carica_estrazioni_wfl_classico ( $g_giorno );
...
$html .= '<h2  class="titolo row">Estrazioni Win For Life Classico <br />' . $newDate . '</h2>';
// $html .= '<ul class="pager">';
// if ($g_giorno != 1871) {
