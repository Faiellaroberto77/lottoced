...
$today = date ( "Y-m-d" );
$tabella = "lotto_maxritardiattuali_wfl_g" . $today . lastdate_winforlife_grattacielo($today);
...
if (! empty ( $listAll )) {
	...
	echo '<h2 class="titolo row">I numeri piu\' ritardatari<br /> Win for Life Grattacielo</h2>';
	echo '</div>';
