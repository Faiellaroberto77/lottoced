...
$today = date ( "Y-m-d" );
$tabella = "lotto_maxritardiattuali_wfl_c" . $today . lastdate_winforlife_classico($today);
...
if (! empty ( $listAll )) {
	...
	echo '<h2 class="titolo row">I numeri piu\' ritardatari<br /> Win for Life classico</h2>';
	echo '</div>';
