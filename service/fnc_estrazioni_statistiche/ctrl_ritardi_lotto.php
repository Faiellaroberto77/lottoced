...
$tabella = "lotto_maxritardiattuali" . lastdate ();
...
echo '<h2 class="titolo row">I numeri piu\' ritardatari<br /> gioco del lotto</h2>';
echo '</div>';
...
foreach ( $listAll as $key1 ) {
	...
	If ($per == "100") {
		echo "<div class=\"progress-bar-success\" role=\"progressbar\" aria-valuenow=\"70\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"width: $per%\">$nru $n Rit: $r</div>";
	} else {
		echo "<div class=\"progress-bar-info\" role=\"progressbar\" aria-valuenow=\"70\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"width: $per%\">$nru $n Rit: $r</div>";
	}
	// echo "</div>";
	echo "</td></tr>";
