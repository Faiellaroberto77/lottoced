...
$today = date ( "Y-m-d" );
$tabella = "tabelloneanalitico_wflc_" . lastdate10el5($today). $today;
...
if (empty ( $listAll ) || $force == 1) {
	...
	$r_estrazioni = Carica_estrazioni_wfl_classico ("","100");
...
// ------------------------------------- TESTATA --------------------------------------
$colonne = 20;
$ne = lastdate_winforlife_classico($today);
$html = aggiungi_titolo('Tabellone analitico Win For Life Classico <br /> '. data_estesa($today) .' ore '. $r_estrazioni[0]->ora .' numero ' . $ne);
